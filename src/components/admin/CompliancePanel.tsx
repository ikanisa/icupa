...
export function CompliancePanel({ tenantId, tenantRegion = "RW", scope = "tenant" }: CompliancePanelProps) {
  ...
  const createTask = useCreateComplianceTask(tenantId);
  const updateTask = useUpdateComplianceTask(tenantId);
            ...
            onClick={async () => {
              ...
              try {
                ...
                toast({
                  ...
                  description: error?.message ?? "Unexpected error creating compliance task.",
                  variant: "destructive",
                });
              }
            }}
                        ...
                        onValueChange={async (value) => {
                          ...
                          try {
                            ...
                            toast({
                              ...
                              description: error?.message ?? "Unexpected error updating status.",
                              variant: "destructive",
                            });
                          } finally {
                        ...
                        onValueChange={async (value) => {
                          ...
                          try {
                            ...
                            toast({
                              ...
                              description: error?.message ?? "Unexpected error updating severity.",
                              variant: "destructive",
                            });
                          } finally {
                            setPendingUpdateId(null);
                        ...
                        onChange={async (event) => {
                          ...
                          try {
                            ...
                            toast({
                              ...
                              description: error?.message ?? "Unexpected error updating due date.",
                              variant: "destructive",
                            });
                          } finally {
                            setPendingUpdateId(null);
                          ...
                          onClick={async () => {
                            ...
                            try {
                              ...
                              toast({
                                ...
                                description: error?.message ?? "Unexpected error resolving task.",
                                variant: "destructive",
                              });
                            } finally {
                              setPendingUpdateId(null);
